...
#################################################
# Note: this was copied from the_circus, which 
# was initially claude produced
# the goal here is to break down Claude's code
# and make more functions enhance its usuability
# and functionality
#################################################

# Main function
def create_rap_video(
                        audio_path, 
                        lyrics_json_path, 
                        video_segments, 
                        output_path
